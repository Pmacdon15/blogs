...
export default function Home() {
  ...
  return (
    <main className="flex flex-col text-foreground bg-background relative overflow-hidden selection:bg-primary/30">
      ...
      <div className="absolute top-0 left-0 -translate-x-1/4 -translate-y-1/4 w-160 h-160 bg-primary/10 rounded-full blur-[140px] pointer-events-none mix-blend-screen" />
      <div className="absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4 w-140 h-140 bg-blue-500/10 rounded-full blur-[140px] pointer-events-none mix-blend-screen" />
      ...
      <div className="flex-1 w-full max-w-6xl mx-auto px-6 py-20 lg:py-32 flex flex-col gap-14 relative z-10">
        <div className="flex flex-col gap-6 text-center md:text-left max-w-3xl">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter bg-linear-to-br from-white via-white/90 to-white/30 bg-clip-text text-transparent drop-shadow-sm">
          ...
          <Suspense
            fallback={
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <Skeleton className="h-80 w-full rounded-2xl bg-card border border-border/20 shadow-lg" />
                <Skeleton className="h-80 w-full rounded-2xl bg-card border border-border/20 shadow-lg" />
                <Skeleton className="h-80 w-full rounded-2xl bg-card border border-border/20 shadow-lg" />
              </div>
            }
